...
# The kind under which the built-in BOS agent (registered as an ep_agent factory
# in bos.config.bos_agent) is registered, and the kind create_agent /
# get_main_agent_kind resolve to when no agent is otherwise specified. Configs
# reference it by this literal name.
