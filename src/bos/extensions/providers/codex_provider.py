...
DEFAULT_ORIGINATOR = "bos"


@ep_provider(name="codex")
async def codex_complete(
    ...
    **kwargs: Any,
    ...
    if isinstance(response_format, dict):
        if response_format.get("type") not in ("json_schema", "json_object", "text"):
            body["response_format"] = {
                "type": "json_schema",
                "json_schema": {"name": "CustomSchema", "strict": True, "schema": response_format},
            }
        else:
...
def _strip_model_prefix(model: str) -> str:
    if model.startswith("openai-codex/") or model.startswith("openai_codex/") or model.startswith("codex/"):
