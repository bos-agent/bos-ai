# BEP 11: Agent-Backed Command Workflow
...
It is also the sanctioned lift of BEP 9's deferred Non-Goal #1 ("LLM-assisted topology generation… explicitly deferred"): BEP 9 built the deterministic substrate; BEP 11 builds the agent layer that parameterizes it.
