...
!!! note "Stub"
    This page is a starting point. Document each `boscli` command group with its
    options and examples.

`boscli` is the command-line entry point for BOS.
...
| --- | --- |
| `boscli ask "<prompt>"` | One-shot query to the agent. |
